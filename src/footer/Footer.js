    ...
    <>
      <div className="footer">
            <div className="company_info">
              ...
              <hr></hr>
              <h4>Địa chỉ</h4>
              <p className="company_info-item">
                Số 315 Trường Chinh, Thanh Xuân Hà Nội
              </p>
              <h4>Số điện thoại</h4>
            ...
            <div className="register_for_news">
              ...
              <p style={{ color: "grey" }}>
                Đăng ký với chúng tôi để nhận email về thông tin mới nhất,
                khuyến mại đặc biệt và các sự kiện độc đáo
              </p>
            </div>
      </div>
    </>
