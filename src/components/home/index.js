    ...
    <div className="Home">
      ...
      <div className="product_details">
        ...
        <div className="product_news ">
          <div className="product_detail" data-aos="flip-left">
            <img src="" alt=""></img>
        ...
        <div className="product">
          <div className="product-list">
            <div className="product-list_items" data-aos='fade-up'>
      ...
      <div id="carouselExampleIndicators" className="carousel slide slider" data-bs-ride="carousel" data-aos="zoom-in" data-aos-duration="4000">
      ...
      <div className="company_detail" data-aos="fade-left" >
      ...
      <div className="news-events">
        <div className="main_news">
          ...
          <div className="cards_news">
            <div className="card" style={{ width: '24rem' }} data-aos="flip-left" data-aos-duration="3000">
              <img
      ...
      <div className="company_achivement">
        <div className="achivement_list">
          <div className="achivement" data-aos="fade-up">
            <h2>70</h2>
